...
Totals: 446 papers (⭐ core 139) | 438 deep-dive reports | 363 original PDFs | 152 Chinese translations. Evidence levels: [P] proceedings / [A] officially accepted / [R] preprint / [B] book or survey. Main conference, journal, workshop and preprint are always labelled separately.
...
- `papers/`: 363 originals; `papers_zh/`: 152 layout-preserving Chinese translations with `*.inspect.json` QA. Missing translations are being filled (`scripts/translate_batch.sh`).
